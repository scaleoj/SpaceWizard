...
[CreateAssetMenu(menuName = "ScriptableObjects/Weapons/Abilities/HealPhysicalArmor")]

public class HealPA : Ability
{ 
    public override void Attack(GameObject target, int distance)
    {
        ...
        target.GetComponent<Character>().CharStats.TakeHeal(0,physical_heal, 0, target);
