...
[CreateAssetMenu(menuName = "ScriptableObjects/Weapons/Abilities/Healhealth")]

public class HealHealth : Ability
{ 
    public override void Attack(GameObject target, int distance)
    {
        ...
        target.GetComponent<Character>().CharStats.TakeHeal(health_heal,0, 0, target);
